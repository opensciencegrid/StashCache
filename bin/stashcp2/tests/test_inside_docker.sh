...
stashcp --cache=$XRD_CACHE osgconnect/dweitzel/blast/queries/query1 ./
...
stashcp --cache=$XRD_CACHE --method=cvmfs,xrootd -d /osgconnect/dweitzel/blast/queries/query1 ./
...
# Perform methods test
stashcp --cache=$XRD_CACHE --method=xrootd -d /osgconnect/dweitzel//blast/queries/query1 ./
...
# Perform methods test
stashcp --cache=$XRD_CACHE --method=http,xrootd -d /osgconnect/dweitzel/blast/queries/query1 ./
...
# Scheme test
stashcp --cache=$XRD_CACHE --method=http,xrootd -d stash:///osgconnect/dweitzel/blast/queries/query1 file:///tmp
...
stashcp --cache=$XRD_CACHE -d -r /osgconnect/dweitzel/blast/queries ./
ls -lah
